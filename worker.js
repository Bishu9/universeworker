...
const listProxy = [
    ...
    { path: '/aws', proxy: '43.204.80.35'},
    { path: '/azure', proxy: '20.235.220.189' },
...
<div class="config-section" style="background-color: rgba(10, 10, 10, 0.8); color: #fff44f; border: 2px solid #fff44f;">
    <p style="color: #fff44f;"><strong>ISP:</strong> ${data.isp} (${data.countryCode})</p>
    <hr style="border-color: #fff44f; width: 100%; margin-left: auto; margin-right: auto;" />
    <div class="config-toggle">
        ...
        <div class="config-content">
            <div class="config-block" style="background-color: rgba(0, 0, 0, 0.3);">
                <h3 style="color: #fff44f;">TLS:</h3>
                <p class="config">${clashConfTls}</p>
                <button class="button" onclick='copyClash("clashTls${path}")'><i class="fa fa-clipboard"></i>Copy</button>
            </div>
            <hr style="border-color: #fff44f; width: 75%; margin-left: auto; margin-right: auto;" />
            <div class="config-block" style="background-color: rgba(0, 0, 0, 0.3);">
                <h3 style="color: #fff44f;">NTLS:</h3>
...
<hr class="config-divider" style="background: linear-gradient(to right, transparent, #fff44f, transparent); margin: 40px 0;" />
`;
...
<div class="config-section" style="background-color: rgba(10, 10, 10, 0.8); color: #fff44f; border: 2px solid #fff44f;">
    ...
    <div class="config-toggle">
        ...
        <div class="config-content">
            <div class="config-block" style="background-color: rgba(0, 0, 0, 0.3);">
                <h3 style="color: #fff44f;">TLS:</h3>
                <p class="config" style="color: #fff44f;">${vlessTlsFixed}</p>
                <button class="button" onclick='copyToClipboard("${vlessTlsFixed}")'><i class="fa fa-clipboard"></i>Copy</button>
            </div>
            <hr style="border-color: #fff44f; width: 75%; margin-left: auto; margin-right: auto;" />
            <div class="config-block" style="background-color: rgba(0, 0, 0, 0.3);">
                <h3 style="color: #fff44f;">NTLS:</h3>
                <p class="config" style="color: #fff44f;">${vlessNtlsFixed}</p>
...
.config-divider {
    border: none;
    height: 1px;
    background: linear-gradient(to right, transparent, #fff44f, transparent);
    margin: 40px 0;
        }
    ...
    <div class="container">
        <div class="header">
            <div class="profile-container">
				<img src="https://raw.githubusercontent.com/abhi7pika/Pics/refs/heads/main/JPEG%20image.jpeg" alt="VLESS CLOUDFLARE" class="profile-pic">
				<h2 class="profile-name">UNIVERSE PRIVATE VLESS</h2>
			</div>
        </div>
		...
		<div id="info" class="content">
			<p>Workers supports wildcard <strong>support.zoom.us</strong></p>
			<p>You Can Contact Me On Telegram: <a href="https://t.me/universe9720" target="_blank" style="color: #fff44f; text-decoration: none;">UNIVERSE OP</a></p>
			<!-- Tambahkan tombol CHAT di sini -->
			<a href="https://t.me/universe9720" target="_blank">
